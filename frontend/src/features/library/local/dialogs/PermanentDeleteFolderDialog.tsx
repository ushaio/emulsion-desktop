...
export function PermanentDeleteFolderDialog({ entry, copy, busy, onClose, onConfirm }: {
  ...
  return (
    <div className="fixed inset-0 z-[140] flex items-center justify-center p-5">
      ...
      <div role="dialog" aria-modal="true" aria-labelledby="permanent-folder-title" className="lg-sheet relative w-full max-w-md rounded-xl border bg-background p-5 shadow-2xl"><GlassBackdrop material="regular" />
