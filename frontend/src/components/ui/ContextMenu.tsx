...
const menuSurfaceClass = 'desktop-menu-surface z-[120] min-w-44 overflow-hidden rounded-lg border border-border bg-popover p-1 text-popover-foreground shadow-xl'
