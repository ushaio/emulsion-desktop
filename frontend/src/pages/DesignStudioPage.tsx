      ...
      {selectedSkill && (() => {
        ...
        return (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/45 p-4" onClick={() => { setSelectedSkill(null); setSkillImageExpanded(false) }}>
            <div className={skillImageExpanded ? 'lg-sheet desktop-dialog-surface flex h-[92vh] w-full max-w-6xl overflow-hidden rounded-lg border' : 'lg-sheet desktop-dialog-surface flex h-[min(86vh,900px)] w-full max-w-3xl overflow-hidden rounded-lg border'} style={{ borderColor: 'var(--border)', backgroundColor: 'var(--card)' }} onClick={event => event.stopPropagation()}><GlassBackdrop material="regular" />
